...
class PointGroupSymmetryFilter(GenericMoleculeFilter):
    ...
    def apply(self, molecules: list[Mol], return_point_group_symmetry: bool = False, **kwargs) -> tuple[Any, list[Mol]] | list[Mol]:  # type: ignore[override]
